...
const Service = () => {
  return (
    <>
    <div className='ml-8'>
        <h1 className="text-2xl font-bold text-gray-800 mb-6 ">How Cashify Work</h1>
    </div>
    ...
    <div className='flex flex-col ml-[40px] border w-[300px] h-[200px] '>
       ...
       <h1 className='text text-bolder text-black'>1. Check Price</h1>
    ...
    <div className='flex flex-col ml-[40px] border w-[300px] h-[200px]'>
       ...
       <h1 className='text text-bolder text-black'>2. Schedule Pickup</h1>
    ...
    <div className='flex flex-col ml-[40px] border-spacing-1 w-[300px] h-[200px]'>
       ...
       <h1 className='text text-bolder text-black'>3. Get Paid </h1>
